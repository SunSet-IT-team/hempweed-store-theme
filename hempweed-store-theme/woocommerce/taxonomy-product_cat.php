...
// 4️⃣ Другие товары (исключаем текущую категорию + уже показанные товары)
$other_args = [
    'post_type'      => 'product',
    'posts_per_page' => -1,
    'post__not_in'   => $displayed_products, // исключаем уже показанные
    'tax_query'      => [
        [
            'taxonomy' => 'product_cat',
            'field'    => 'term_id',
            'terms'    => $category->term_id,
            'operator' => 'NOT IN' // правильно исключаем текущую категорию
        ]
    ]
];
